	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Thêm loại hàng hóa mới</h1>
			...
			<div class="container-fluid">
				<form class="form-horizontal form-material mx-2" action="loaihhthem"
						...
						<div class="col-lg-3 col-xlg-3 col-md-5">
							<div class="card">
								<div class="card-body profile-card">
									<center class="mt-3">
										<img id="previewImage" src="../page/img/loai_hh/"
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text" placeholder=""
												class="form-control ps-0 form-control-line" name="ghi_chu" />
										</div>
									</div>
									<div class="form-group">
