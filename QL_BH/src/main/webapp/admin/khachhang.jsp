...
<body>
													...
													<c:forEach items="${requestScope.data}" var="d"
														...
														<tr class="odd gradeX">
															...
															<td style="vertical-align: middle;"><img
																...
																height="100"></td>
															<td style="vertical-align: middle;">KH_${d.ma_kh}</td>
															...
															<td style="vertical-align: middle;"><a
																...
																href="suakhachhang?ma_kh=${d.ma_kh}">Sửa</a>&nbsp;&nbsp;&nbsp;
																<a href="#" class="btn btn-danger text-white"
																onclick="xoa_KH('${d.ma_kh}')">Xóa</a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
	...
	<script>
		function xoa_KH(ma_kh) {
			if (confirm("Bạn có muốn xóa khách hàng có mã KH_" + ma_kh
					+ " này không?")) {
				window.location = "xoakhachhang?ma_kh=" + ma_kh;
			}
		}
	</script>
	<!-- jQuery -->
