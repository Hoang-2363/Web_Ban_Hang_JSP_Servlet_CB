	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Sửa thông tin loại hàng hóa</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /.row -->
			...
			<div class="container-fluid">
				<c:set var="c" value="${requestScope.lhh}" />
				<form class="form-horizontal form-material mx-2" action="sualoaihh"
						...
						<div class="col-lg-3 col-xlg-3 col-md-5">
							<div class="card">
								<div class="card-body profile-card">
									<center class="mt-3">
										<img id="previewImage" src="../page/img/loai_hh/${c.anh}"
							...
							<div class="card">
								<div class="card-body">
									<div class="form-group">
										<label class="col-md-12 mb-0">Mã loại hàng hóa: </label>
										<div class="col-md-12">
											<input type="text" placeholder=""
												class="form-control ps-0 form-control-line" required
												value="${c.ma_lhh}" readonly="readonly" name="ma_loai_hang" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-12 mb-0">Tên loại hàng hóa: </label>
										<div class="col-md-12">
											<input type="text" placeholder=""
												class="form-control ps-0 form-control-line" required
												value="${c.ten_loai_hang}" name="ten_loai_hang" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text" placeholder=""
												...
												value="${c.ghi_chu}" name="ghi_chu" />
										</div>
									</div>
									<div class="form-group">
										<div class="col-sm-12 d-flex">
											<a class="btn btn-info mx-auto mx-md-0 text-white"
												href="loaihanghoa">Thoát</a> <input type="submit"
