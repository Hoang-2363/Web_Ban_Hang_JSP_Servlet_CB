...
<body>
	...
	<div class="container-fluid fruite py-5">
		<div class="container py-5">
			<h1 class="mb-4">Danh sách hàng hóa trong giỏ hàng</h1>
				...
				<table class="table">
					<thead>
						<tr class="fs-3">
							...
							<th scope="col" style="width: 10%; text-align: center;">Giá
								bán</th>
							<th scope="col" style="width: 18%; text-align: center;">Số
								lượng</th>
							<th scope="col" style="width: 14%; text-align: center;">Thành
								tiền</th>
							<th scope="col" style="width: 10%; text-align: center;">Xử
								lý</th>
						</tr>
					</thead>
					<tbody>
						...
						<c:forEach items="${o.items}" var="i">
							...
							<tr class="fs-4" style="text-align: center; font-weight: bold;">
								<td style="width: 5%;">
									<p class="mb-0 mt-4">${t}</p>
								</td>
								<th scope="row" style="width: 10%;">
									<div class="d-flex align-items-center">
										<img src="page/img/hanghoa/${i.hang_hoa.anh}"
											class="img-fluid ms-4 rounded-circle"
											style="width: 80px; height: 80px;" alt="">
									</div>
								</th>
								<td>
									<p class="mb-0 mt-4">${i.hang_hoa.ten_hang}</p>
								</td>
								<td style="width: 10%;">
									<p class="mb-0 mt-4">
										<fmt:formatNumber type="number" value="${i.gia_ban}" />
									</p>
								</td>
								<td style="width: 18%;">
									<div class="input-group quantity mt-4 ms-5"
										style="width: 113px;">
										<div class="input-group-btn">
											<a
												class="btn btn-sm btn-minus rounded-circle bg-light border"
												href="giohangxuly?so_luong=-1&ma_hang=${i.hang_hoa.ma_hang}">
												<i class="fa fa-minus"></i>
											</a>
										</div>
										<input type="text"
											class="form-control form-control-sm text-center border-0 fs-4"
											value="${i.so_luong}">
										<div class="input-group-btn">
								...
								<td style="width: 14%;">
									<p class="mb-0 mt-4">
										<fmt:formatNumber type="number"
											value="${(i.gia_ban*i.so_luong)}" />
									</p>
								</td>
								<td style="width: 10%;">
									<form action="giohangxuly" method="post">
										<input type="hidden" name="ma_hang"
											value="${i.hang_hoa.ma_hang}">
			...
			<div class="row g-4 justify-content-end">
				...
				<div class="col-sm-8 col-md-7 col-lg-6 col-xl-6">
					<div class="bg-light rounded">
						<div
							class="py-4 mb-4 border-bottom d-flex justify-content-between">
							<h2 class="mb-0 ps-4 me-4">Tổng tiền:</h2>
							<h2 class="mb-0 pe-4">
						...
						<div class="d-flex justify-content-center">
							<a
								...
								href="dathang">Tiến hành đặt hàng</a>
						</div>
					</div>
				</div>
			</div>
