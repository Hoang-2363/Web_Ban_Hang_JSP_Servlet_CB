...
<body>
	...
	<div class="container-fluid page-header py-5"
		...
		<h1 class="text-center text-white display-6">Phản hồi khách hàng</h1>
		<ol class="breadcrumb justify-content-center mb-0">
			<li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
			<li class="breadcrumb-item active text-white">Phản hồi khách
				hàng</li>
		</ol>
	</div>
	...
	<div class="container-fluid testimonial py-5">
		<div class="container py-5">
			<div class="testimonial-header text-center">
				<h1 class="display-5 mb-5 text-dark">Phản hồi từ khách hàng!</h1>
			</div>
					...
					<div
						...
						<div class="position-relative">
							...
							<div class="mb-4 pb-4 border-bottom border-secondary">
								<p class="mb-0 fw-bold">Lời nhắn: "${d.tin_nhan}"</p>
							</div>
							<div class="d-flex align-items-center flex-nowrap">
								<div class="bg-secondary rounded">
									<img src="page/img/khachhang/${d.anh}"
										class="img-fluid rounded" style="width: 100px; height: 100px;"
										alt="">
								</div>
								<div class="ms-4 d-block">
									<h4 class="text-dark">${d.ten_kh}-${d.sdt}</h4>
									<h6 class="m-0 pb-3">Thời gian: ${d.thoi_gian}</h6>
