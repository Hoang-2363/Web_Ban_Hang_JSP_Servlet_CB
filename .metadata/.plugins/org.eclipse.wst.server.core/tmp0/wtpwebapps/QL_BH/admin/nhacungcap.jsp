...
<body>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			<ul class="nav navbar-nav navbar-left navbar-top-links">
				<li><a href="http://localhost:8000/QL_BH/"><i class="fa fa-home fa-fw"></i> Website</a></li>
			</ul>
												...
												<tbody style="text-align: center;">
													<c:forEach items="${requestScope.data}" var="d"
														...
														<tr class="odd gradeX">
															...
															<td style="vertical-align: middle;">${d.ten_nha_cung_cap}</td>
															<td style="vertical-align: middle;">${d.dia_chi}</td>
															<td style="vertical-align: middle;">${d.sdt}</td>
															<td style="vertical-align: middle;">${d.email}</td>
															<td style="vertical-align: middle;"><a
																class="btn btn-info text-white"
																href="suanhacungcap?ma_ncc=${d.ma_nha_cung_cap}">Sửa</a>&nbsp;&nbsp;&nbsp;
																<a href="#" class="btn btn-danger text-white"
																onclick="xoa_NCC('${d.ma_nha_cung_cap}')">Xóa</a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
	...
	<script>
		function xoa_NCC(ma_ncc) {
			if (confirm("Bạn có muốn xóa loại hàng hóa có mã " + ma_ncc
					+ " này không?")) {
				window.location = "xoanhacungcap?ma_ncc=" + ma_ncc;
			}
		}
	</script>
	<!-- jQuery -->
