	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">Sửa thông tin nhà cung cấp</h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<!-- /.row -->
			...
			<div class="container-fluid">
				<c:set var="c" value="${requestScope.ncc}" />
				<form class="form-horizontal form-material mx-2"
					action="suanhacungcap" method="post">
					<div class="row">
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text" placeholder=""
												...
												value="${c.ma_nha_cung_cap}" readonly="readonly"
