...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="container-fluid">
				<c:set var="c" value="${requestScope.kh}" />
				<form class="form-horizontal form-material mx-2"
					action="suakhachhang" method="post" enctype="multipart/form-data">
					<div class="row">
						<!-- Column -->
						<div class="col-lg-3 col-xlg-3 col-md-5">
							<div class="card">
								<div class="card-body profile-card">
									<center class="mt-3">
										<img id="previewImage" src="../page/img/khachhang/${c.anh}"
							...
							<div class="card">
								<div class="card-body">
									<div class="form-group">
										<label class="col-md-12 mb-0">Mã khách hàng: </label>
										<div class="col-md-12">
											<input type="text" placeholder=""
												class="form-control ps-0 form-control-line" required
												value="${c.ma_kh}" readonly="readonly" name="ma_kh" />
										</div>
									</div>
									<div class="form-group">
