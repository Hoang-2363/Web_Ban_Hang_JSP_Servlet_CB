...
<body>
	...
	<div id="wrapper">
						...
						<div class="panel panel-default">
							...
							<div class="panel-heading">
								<a class="btn btn-success mx-auto mx-md-0 text-white"
									href="themhanghoa"> + Thêm hàng hóa </a>
							</div>
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<thead>
											<tr>
												...
												<th style="width: 50px;">Mã hàng hóa</th>
												<th style="width: 70px;">Tên hàng hóa</th>
												<th style="width: 50px;">Giá bán</th>
												<th style="width: 50px;">Giá nhập</th>
												<th style="width: 50px;">Đơn vị tính</th>
												<th style="width: 50px;">Số lượng tồn</th>
												<th>Ghi chú</th>
												<th style="width: 70px;">Mã nhà cung cấp</th>
												<th style="width: 50px;">Mã loại hàng</th>
											...
											<c:forEach items="${requestScope.data}" var="d"
												...
												<tr class="odd gradeX">
													...
													<td style="vertical-align: middle;"><img
														src="../page/img/hanghoa/${d.anh}" alt="" width="100"
														height="100"></td>
													<td style="vertical-align: middle;">HH_${d.ma_hang}</td>
													<td style="vertical-align: middle;">${d.ten_hang}</td>
													<td style="vertical-align: middle;"><fmt:formatNumber value="${d.gia_nhap}" type="number" /></td>
													<td style="vertical-align: middle;"><fmt:formatNumber value="${d.gia_ban}" type="number" /></td>
													<td style="vertical-align: middle;">${d.don_vi_tinh}</td>
													<td style="vertical-align: middle;">${d.so_luong}</td>
													<td style="vertical-align: middle;">${d.ghi_chu}</td>
													<td style="vertical-align: middle;">${d.ma_nha_cung_cap}</td>
													<td style="vertical-align: middle;">${d.ma_loai_hang}</td>
													<td style="vertical-align: middle;"><a
														class="btn btn-info text-white"
														href="suahanghoa?ma_hang=${d.ma_hang}">Sửa</a>&nbsp;&nbsp;&nbsp;
														<a href="#" class="btn btn-danger text-white"
														onclick="xoa_HH('${d.ma_hang}')">Xóa</a></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
		...
		<script>
			function xoa_HH(ma_hang) {
				if (confirm("Bạn có muốn xóa hàng hóa có mã HH_" + ma_hang
						+ " này không?")) {
					window.location = "xoahanghoa?ma_hang=" + ma_hang;
				}
			}
		</script>
		<!-- jQuery -->
